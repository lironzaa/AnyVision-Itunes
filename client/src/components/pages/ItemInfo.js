      ...
      songContent = (
        <Fragment>
          ...
          <div className="card-body">
            <p className="card-text"><span className="font-weight-bold">Artist :</span> {selectedSong.artistName}</p>
            <p className="card-text"><span className="font-weight-bold">Album :</span> {selectedSong.collectionName}</p>
            <p className="card-text"><span className="font-weight-bold">Type :</span> {selectedSong.kind}</p>
            <p className="card-text"><span className="font-weight-bold">Genre :</span> {selectedSong.primaryGenreName}</p>
            <p className="card-text"><span className="font-weight-bold">Release Date :</span> {selectedSong.releaseDate}</p>
